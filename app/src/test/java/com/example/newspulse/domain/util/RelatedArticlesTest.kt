...
class RelatedArticlesTest {
    ...
    // base article should not be included to related
    @Test
    ...
    // same score articles saved by publish time
    @Test
    ...
    // tests that articles with more shared interests score higher.
    ...
    // tests that scoring combiens sshared interests and source
    ...
    // Score: 0 shared interests + 5 (same source) = 5 points., articles from same course pritirized 
    @Test
    ...
    // testing multiple articles with same score
    @Test
